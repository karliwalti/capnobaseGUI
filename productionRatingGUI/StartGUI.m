...
% STARTGUI M-file for StartGUI.fig
%      STARTGUI by itself, creates a new STARTGUI or raises the
%      existing singleton*.
%
...
%
%      STARTGUI('Property','Value',...) creates a new STARTGUIor raises the
...
selection = questdlg(['Quit CapnoBase GUI Signal Evaluation Tool and all associated windows without saving?'],...
...
mkdir([conf.data.rootfolder filesep newfoldername])
